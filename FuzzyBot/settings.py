"""
Django settings for FuzzyBot project.
...
SECRET_KEY = 'lxpxyy0-9d%kd8xa%q_296rl#tll7si+hcaf)(sn%+x_i7rmq+'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['*']  # TODO: handle later
...
WSGI_APPLICATION = 'FuzzyBot.wsgi.application'
